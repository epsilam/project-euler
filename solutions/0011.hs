main = print $ maximum [maxHorizontalProducts, maxVerticalProducts, maxDiagDownRightProducts, maxDiagDownLeftProducts]
...
maxHorizontalProducts    :: Int
maxHorizontalProducts    = maxProducts 0 0     0 1     0 2     0 3       0 (-1) (-4)
maxVerticalProducts      :: Int
maxVerticalProducts      = maxProducts 0 0     1 0     2 0     3 0       0 (-4) (-1)
maxDiagDownRightProducts :: Int
maxDiagDownRightProducts = maxProducts 0 0     1 1     2 2     3 3       0 (-4) (-4)
maxDiagDownLeftProducts  :: Int
maxDiagDownLeftProducts  = maxProducts 0 0     1 (-1)  2 (-2)  3 (-3)    3 (-4) (-1)

maxProducts i0 j0 i1 j1 i2 j2 i3 j3 d x y =
    maximum [product $ set i j | i <- [0 .. (length bigsquare) + x], j <- [d .. (length (bigsquare !! 0)) + y]]
    where
        set i j =
